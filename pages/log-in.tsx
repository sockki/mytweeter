    ...
    <div className="w-full max-w-xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center justify-center space-x-2">
          <button className="mt-5 w-2/5 rounded-lg bg-sky-300 text-gray-100 text-lg hover:bg-sky-600">Login</button>
          <button className="mt-5 w-2/5 rounded-lg bg-sky-300 text-gray-100 text-lg hover:bg-sky-600" onClick={onCreateAccount}>Create-account</button>
        </div>
      </form>
    </div>
  );
